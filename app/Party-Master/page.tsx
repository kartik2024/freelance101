export default function(){
    return(
        ...
        <div className="pt-0.5 pb-0.5 bg-purple-950">
            <div className="pl-1 ml-1 bg-yellow-400 w-35 mt-1"><b>Party Master</b></div>
        </div>
        ...
        <div className="flex">
            ...
            <div className="h-12 mt-1 mr-1 flex ml-1 bg-purple-950 justify-between gap-2 ">
            <div className="flex">
...
.
            ...
            {/* stop/running */}
               <div className="h-10 px-1 m-1 w-40">
                    ...
                    <div className="h-1/2 bg-yellow-400 text-center">20/20</div>
                </div>
                </div>
            </div>
        </div>
    ...
    {/* first box */}
        ...
        <div className="w-335">
            ...
            <div className="w-335 h-114 bg-amber-50">
                ...
                <input type="text" name="" placeholder="DEFAULT" id="" className="w-80 border-1 ml-3 bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500"  />
                <p className="p-2 pl-3"><b>Code:</b></p>
                <input type="text" name="" placeholder="DEFAULT" id="" className="w-80 border-1 ml-3 bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500"  />
            </div>
        </div>
            </div>
